...
class ContactRequest extends FormRequest
{
    ...
    public function messages()
    {
        ...
        'tell_1.numeric'      => '電話番号は数値で入力してください',
        'tell_1.digits_between' => '電話番号は5桁以内で入力してください',
        'tell_2.required'     => '電話番号を入力してください',
        'tell_2.numeric'      => '電話番号は数値で入力してください',
        'tell_2.digits_between' => '電話番号は5桁以内で入力してください',
        'tell_3.required'     => '電話番号を入力してください',
        'tell_3.numeric'      => '電話番号は数値で入力してください',
        'tell_3.digits_between' => '電話番号は5桁以内で入力してください',
